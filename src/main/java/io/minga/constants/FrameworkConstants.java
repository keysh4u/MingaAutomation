...
public final class FrameworkConstants {
    ...
    public static final String EXCEL_BASIC_LOGIN = PropertiesHelpers.getValue("EXCEL_BASIC_LOGIN");
    ...
    public static final String URL_MINGA_CAN_USER = PropertiesHelpers.getValue("URL_MINGA_CAN_USER");
